...
public class Bullet_EnemyCombatX : BulletBase
{
    ...
    public override void Shoot(int index, BehaviorNormalAttack behavior)
    {
        ...
        rends.color = BG_Painter.enemy_body;
    }

    public override void Shoot(int index, Vector3 arrivalLocation)
    {
        Debug.Log("You used the wrong bullet. Use CombatRedX instead. THis bullet should get interrupted by terrain, not bypass.");
    }
    #endregion
